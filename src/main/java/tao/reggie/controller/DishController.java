...
import tao.reggie.service.DishService;
...
//        redisTemplate.delete(keys);
    ...
    public R<List<DishDto>> list(Dish dish) {
        ...
        String key = "dish_" + dish.getCategoryId() + "_" + dish.getStatus();//dish_1921215489449_1
        //先从redis中获取缓存数据
